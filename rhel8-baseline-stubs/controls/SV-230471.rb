...
$ sudo ls -al 
/etc/audit/rules.d/*.rul

-rw-r----- 1 root root 1280es Feb 16 17:09 audit.rules
...
$ sudo chmod 0640 /etc/audit/auditd.conf"
  ...
  world_writable_dirs = command('ls /etc/audit/rules.d/*.rules').stdout.split('\n')
  if world_writable_dirs.empty?
    describe 'folder empty' do 
      skip 'no files found'
    end
  else
